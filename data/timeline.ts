...
export const timelineEvents: TimelineEvent[] = [
  ...
  { year: "1933", sortYear: 1933, title: "NS-Diktatur", text: "Mit der nationalsozialistischen Machtübernahme beginnen Gleichschaltung, Verfolgung und Terror.", era: "Demokratie & Diktatur", missionId: "unter-der-oberflaeche", source: "Zeitreisen Berlin" },
  { year: "1945", sortYear: 1945, title: "Kriegsende und Viermächte-Status", text: "Berlin ist schwer zerstört und wird in vier Besatzungssektoren aufgeteilt.", era: "Demokratie & Diktatur", missionId: "unter-der-oberflaeche", source: "Wikipedia" },
  { year: "1948/49", sortYear: 1948, title: "Blockade und Luftbrücke", text: "Die Westsektoren werden blockiert und fast ein Jahr lang aus der Luft versorgt.", era: "Geteilte Stadt", missionId: "frontstadt", source: "Zeitreisen Berlin" },
  { year: "1953", sortYear: 1953, title: "Aufstand vom 17. Juni", text: "Proteste gegen Normerhöhungen weiten sich in Ost-Berlin und der DDR zum Aufstand aus.", era: "Geteilte Stadt", missionId: "frontstadt", source: "Zeitreisen Berlin" },
  ...
  { year: "1991/99", sortYear: 1991, title: "Parlament und Regierung ziehen nach Berlin", text: "Der Bundestag beschließt 1991 den Umzug; seit 1999 arbeiten Parlament und Bundesregierung in Berlin.", era: "Vereinte Hauptstadt", missionId: "nach-der-linie", source: "Wikipedia" },
];
